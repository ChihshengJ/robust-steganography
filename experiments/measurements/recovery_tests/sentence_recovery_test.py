...
from systems.config.system_prompts import CORPORATE_MONOLOGUE_ALT
...
def main():
    ...
    hash_fn = PCAHash(
        pca_dir=pca_artifacts_dir("enron_emails"),
    ...
    system_prompt: str = CORPORATE_MONOLOGUE_ALT

    system = SentenceStegSystem(
        client,
        hash_fn,
        ecc,
        system_prompt,
