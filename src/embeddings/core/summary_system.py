...
from ..config.system_prompts import FACT_GENERATION, FACT_CONTINUATION, FACT_DECOMPOSE, FACT_SUMMARY
...
class SummarySystem:
    ...
    def hide_message(self, data:Any, article: str) -> str:
        ...
        # optional facts
        prompt_for_optional_facts: str = article + "\nKey facts:\n" + base_facts + "\nOptional facts:\n"
    ...
    def recover_message(self, stego_text: str):
        ...
        print(f"optional facts after decomposed: {len(optional_facts)},\n {optional_facts}")
