...
They each uses a shareable state (i.e., the trained classifier, the ontology with the frequency table, or the domain-specific PCA model).
...
\subsection{Covert communication between agents}
...
Thus, meaning-preserving paraphraser between agent communication is a reasonable defense against agents using traditional steganography that designed around covertness only.
