...
First, we compare against only a single baseline. This is largely because prior methods are \emph{a priori} vulnerable to global paraphrases; the comparison to Discop is meant to make this point clear.
...
Finally, some implementation details (e.g., prompts) required careful tuning to produce the expected behavior, suggesting that iteration may be required when adapting our approach to new tasks and domains.
